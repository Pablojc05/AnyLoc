...
class Catec(CustomDataset):
    """
    Returns dataset class with images from database and queries for the catec dataset. 
    """
    def __init__(self,args,datasets_folder='/home/upia/Downloads/catec_dataset',dataset_name="catec",split="train",use_ang_positives=False,dist_thresh = 10,ang_thresh=20,use_mixVPR=False,use_SAM=False):
        super().__init__()
        ...
        # self.gt_positives = np.load(os.path.join(self.datasets_folder,self.dataset_name,"catec_gt.npy"),allow_pickle=True)
